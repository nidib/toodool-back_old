...
const userServicesQueryStrings = {
	...
	getUsernameWithInfo: `SELECT ${userTable}.username, ${TABLES.userInfo}.first_name, ${TABLES.userInfo}.last_name, ${TABLES.userInfo}.email, ${TABLES.userInfo}.nickname FROM ${userTable} INNER JOIN ${userInfoTable} ON ${userTable}.id = ${TABLES.userInfo}.user_id WHERE ${userTable}.id = $1`
};
